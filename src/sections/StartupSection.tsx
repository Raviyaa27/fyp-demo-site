...
export default function StartupSection() {
  return (
    <Section
      id="startup"
      kicker="Section 8 · Running the Platform"
      title="Execution Order / Service Startup Guide"
      intro={
        <>
          Services must come up in dependency order: storage first, then the global knowledge layer, then the
          regional agents, and finally the traffic generators. This is also the recommended order for a live
          demonstration.
        </>
      }
    >
